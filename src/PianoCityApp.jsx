...
const concertsData = [
  ...
  },
  {
    ...
    program: 'Classical recital · open-air English garden',
    venue: 'GAM English garden',
    address: 'Via Palestro 18 · Zone 1',
    mapUrl: 'https://www.google.com/maps/search/?api=1&query=GAM+Galleria+d%27Arte+Moderna+Via+Palestro+16+Milano',
    badges: ['walkin'],
    description: 'Award-winning young Italian pianist (Casagrande, debuts at Salzburg, La Scala). Open-air recital in GAM\'s English garden — late afternoon golden light, before the day pivots to Ji Liu and the long GAM evening.',
    whyYou: 'Replaces Segawa — cleaner transit. After Tosarelli ends at 15:00, ~25 min to GAM, arrive relaxed. Trolese ends ~16:40, then one metro line to BiM for Ji Liu at 17:30. No stress, no gamble on train connections.',
    isAlt: false,
  },
  {
    id: 'jiliu',
  ...
  },
  {
    ...
    program: 'Jazz piano · Paolo Conte reworkings · Italian chanson',
    venue: 'GAM Piano Giardino',
    address: 'Via Palestro 18 · Zone 1',
    mapUrl: 'https://www.google.com/maps/search/?api=1&query=GAM+Galleria+d%27Arte+Moderna+Via+Palestro+16+Milano',
    badges: ['walkin'],
    description: 'Jazz pianist reworking Paolo Conte\'s repertoire — Italian chanson-jazz crossover in GAM\'s English garden piano. Warm, unhurried set in the open air before the Main Stage evening begins.',
    whyYou: 'Replaces Sgobbio — Ji Liu ends 18:40, Sgobbio starts 18:30, impossible. Transit to GAM ~20 min, arrive ~19:05. Relax in the garden, catch Blaiotta at 19:50. Then stay seated: Rakotondrabe at 22:00, Khalifé at 23:00. Zero transit for the rest of the night.',
    isAlt: false,
  },
  {
    id: 'rakotondrabe',
...
const alternatesData = [
  ...
  },
  {
    ...
    booking: 'Free, walk-in',
    description: 'Italian pianist-composer. Live piano + real-time electronics that react to his playing — described as "a dialogue with a second self." His Piano Music series has been voted Album of the Year on All About Jazz, Jazzism, Il Manifesto. Voted one of Italy\'s best jazz talents. Released on ECM-adjacent labels.',
    whyNot: 'Ji Liu ends ~18:40, Sgobbio starts 18:30 — impossible overlap. Would be a top pick on any other day. He also plays May 23 at La Goccia at 13:00 if you want a second chance.',
  },
  {
    id: 'alt-barrios',
    day: 'sat',
  ...
  },
  {
    ...
    time: '19:45',
    title: 'Sonic Twins',
    venue: '21 House of Stories — Navigli',
    booking: 'Free, walk-in',
    description: 'Piano duo blending classical, neo-classical, post-minimalist, jazz, ambient and electronic music. Original compositions. Genre-fluid — somewhere between ECM and contemporary classical. Navigli setting is intimate and atmospheric.',
    whyNot: 'Conflicts with Blaiotta at GAM at 19:50 — and Blaiotta keeps you planted for Rakotondrabe at 22:00 and Khalifé at 23:00 with zero transit. Sonic Twins is a good pick if you skip the GAM evening camp. Recommended by a friend.',
  },
  {
    id: 'alt-ligeti',
    day: 'sat',
...
export default function PianoCityProgram() {
  ...
  const [going, setGoing] = useState({
    ...
    trolese: true, jiliu: true, blaiotta: true, rakotondrabe: true, khalife: true, stegonaute: true,
