...
const concertsData = [
  ...
  // SATURDAY
  {
    ...
    dayLabel: 'Sat · 16 May',
    dayNumber: '02',
    dayTitle: 'Three worlds before dinner',
    time: '11:00',
    duration: '~60 min',
    title: 'Sachiko Nakajima — "Japanese Folk Reimagined"',
    program: 'Japanese folk × jazz harmony × free improvisation',
    venue: 'Politecnico di Milano — Giardino di Leonardo',
    address: 'Piazza Leonardo da Vinci 32 · Zone 3',
    mapUrl: 'https://www.google.com/maps/search/?api=1&query=Politecnico+di+Milano+Piazza+Leonardo+da+Vinci+32+Milano',
    badges: ['walkin'],
    isStar: true,
    description: 'Tokyo pianist-composer. Reframes Japanese folk material through jazz harmony and live improvisation. Open-air set in the Politecnico\'s Giardino di Leonardo — a quiet, green campus courtyard tucked between engineering buildings, late Saturday morning sun.',
    whyYou: 'Two of your worlds in one hour: Japanese sensibility + jazz improvisation, outdoors. Sets the morning tone better than any romantic Liszt could.',
    isAlt: false,
  },
  {
    id: 'liszt2',
    ...
    program: 'Roberto Franca & Alessandro Di Lorenzo · four hands',
    ...
    badges: ['walkin'],
    description: '140th-anniversary Liszt marathon. Symphonic Poems 3–6 performed four-hands inside the Rotonda — a former 18th-century cemetery turned exhibition hall, circular architecture, geometry made sacred.',
    whyYou: 'One Liszt set as your "I tasted the marathon" middle. Skip the rest of the marathon; the Rotonda venue + four-hands physical theatre is the whole point in 45 minutes. Nakajima ends ~12:00, M2 Lanza-area transit ~20 min, you arrive just in time.',
    isAlt: false,
  },
  {
    id: 'tosarelli',
    ...
    time: '14:00',
    duration: '~60 min',
    title: 'Lorenzo Tosarelli — "Omaggio a Guinga"',
    program: 'Brazilian harmony · world music × jazz',
    venue: 'Paolo Pini — ex-psychiatric hospital, Zone 9',
    address: 'Via Ippocrate · Zone 9',
    mapUrl: 'https://www.google.com/maps/search/?api=1&query=Paolo+Pini+Via+Ippocrate+Milano',
    badges: ['walkin'],
    isStar: true,
    description: 'Tribute to Guinga — Brazilian composer-guitarist beloved by Pat Metheny, Hermeto Pascoal and the sophisticated post-bossa scene. Italian pianist Lorenzo Tosarelli reads his catalogue through jazz piano harmony. Performed at Paolo Pini, the historic ex-psychiatric hospital that became Milan\'s outsider-art and community-arts site after Basaglia\'s reforms.',
    whyYou: 'Brazilian-jazz harmony is Hermeto-Pascoal-adjacent — your axis. The venue carries its own weight (a site of psychiatric reform and outsider art). Far north (Zone 9), so plan ~30-35 min transit from Besana; afterwards budget ~40 min south-east to Carlo Besta for Segawa.',
    isAlt: false,
  },
  {
    id: 'segawa',
    ...
    time: '16:00',
    duration: '~55 min',
    title: 'Yasuyo Segawa — "Resonating into the future"',
    program: 'Left-hand-only piano · classical × jazz × opera',
    venue: 'Istituto Neurologico Carlo Besta',
    address: 'Via G. Celoria 11 · Zone 3',
    mapUrl: 'https://www.google.com/maps/search/?api=1&query=Istituto+Neurologico+Carlo+Besta+Via+Celoria+11+Milano',
    badges: ['walkin'],
    isStar: true,
    description: 'Japanese pianist Yasuyo Segawa performs the left-hand-only repertoire — works written for or performed by one-handed pianists, including Ravel\'s legendary Concerto pour la main gauche (commissioned by Paul Wittgenstein after he lost his right arm in WWI), Britten, plus crossings into jazz harmony and operatic transcription. Set inside Milan\'s leading neurological research institute, where left-hand piano programs have particular conceptual and clinical resonance.',
    whyYou: 'The most quietly weighted hour of Saturday: Japanese pianist + restricted-means repertoire (one hand can do everything) + a neurological hospital as venue. The kind of concert where the frame is half the experience. Logistically clean: ends ~16:55, then a single metro ride to BiM for Ji Liu at 17:30 — Carlo Besta is in Città Studi, BiM in Pirelli, ~20 min door to door.',
    isAlt: false,
  },
  {
    id: 'jiliu',
  ...
  },
  {
    ...
    time: '18:30',
    duration: '~60 min',
    title: 'Alessandro Sgobbio — "Piano Music 3"',
    program: 'Electronica × musiche originali · outdoor pool venue',
    venue: 'Teatro Franco Parenti — Bagni Misteriosi',
    address: 'Via Pier Lombardo 14 · Zone 1',
    mapUrl: 'https://www.google.com/maps/search/?api=1&query=Bagni+Misteriosi+Via+Pier+Lombardo+14+Milano',
    badges: ['walkin'],
    isStar: true,
    description: 'Italian composer-pianist whose practice sits at the intersection of contemporary classical, jazz harmony, and electronics. "Piano Music 3" is the third installment of his ongoing solo cycle exploring piano + live electronics. Performed inside Bagni Misteriosi — Franco Parenti theater\'s restored 1939 open-air swimming pool, a Milanese architectural treasure used in summer as a literal swimming pool, in May as a performance venue with the water reflecting the sky.',
    whyYou: 'Direct hit on your Hania Rani / Sakamoto axis: piano + electronics + atmospheric venue. Ji Liu ends ~18:40 at BiM (Pirelli) — taxi/metro to Bagni Misteriosi takes 20–25 min, so you\'d catch the back half. Worth it: this venue is once-a-year only, and Sgobbio is exactly the timbre you collect.',
    isAlt: false,
  },
  {
    id: 'rakotondrabe',
    ...
    program: 'Madagascan-French pianist · chanson × jazz × cinematic',
    venue: 'GAM Main Stage',
    address: 'Via Palestro 18 · Zone 1',
    mapUrl: 'https://www.google.com/maps/search/?api=1&query=GAM+Galleria+d%27Arte+Moderna+Via+Palestro+16+Milano',
    badges: ['priority', 'walkin'],
    isStar: true,
    description: 'Paris-based pianist of Malagasy origin. Long-time collaborator and musical director for Camille (the French art-pop singer), has played with -M-, Vanessa Paradis, Sébastien Tellier. His solo work blends French chanson harmony, jazz openness, African rhythmic memory and cinematic restraint. Often compared to a younger Sakamoto cousin of the chanson-tradition.',
    whyYou: 'The missing piece between Ji Liu and the Khalifés — and you\'re already at GAM. Heritage-rooted, harmonically gentle, electronics-adjacent. The kind of pianist Hania Rani would put on a mixtape. Stay seated for Khalifé an hour later.',
    isAlt: false,
  },
  {
    id: 'khalife',
...
const alternatesData = [
  ...
  },
  {
    ...
    venue: 'Rotonda della Besana',
    booking: 'Free, walk-in',
    description: 'Duo Ad Parnassum opens the four-hands marathon — Symphonic Poems 1 & 2 inside the Rotonda\'s former-cemetery rotunda.',
    whyNot: 'Conflicts with Nakajima at 11:00 — Nakajima wins for your taste. Swap in only if you commit to the full deep-Liszt arc.',
  },
  {
    id: 'alt-liszt-789',
    day: 'sat',
    time: '13:30',
    title: 'Liszt 140 — Symphonic Poems 7, 8 & 9',
    venue: 'Rotonda della Besana',
    booking: 'Free, walk-in',
    description: 'Federico Ceriani and Irina Kravchenko continue the four-hands marathon. Same circular space, deeper into the trance.',
    whyNot: 'Conflicts with the transit to Paolo Pini for Tosarelli. Swap in if you want to stay at Besana and let the Liszt marathon become the whole afternoon.',
  },
  {
    id: 'alt-forino',
    day: 'sat',
    time: '13:30',
    title: 'Alberto Forino — "Holding Egos"',
    venue: 'CASVA — Centro di Alti Studi sulle Arti Visive',
    booking: 'Free, walk-in',
    description: 'Pure piano improvisation at Milan\'s visual-arts research center. Free-form, contemporary, intellectually-framed setting.',
    whyNot: 'Same slot as transit to Tosarelli. Swap in for an experimental impro hour if you skip Tosarelli.',
  },
  {
    id: 'alt-liszt-1013',
    day: 'sat',
    time: '14:30',
    title: 'Liszt 140 — Symphonic Poems 10, 11, 12 & 13',
    venue: 'Rotonda della Besana',
    booking: 'Free, walk-in',
    description: 'Carlotta Nicole Lusa and Marino Nahon take over for the final block of poems. Closing four-hands stretch of the marathon.',
    whyNot: 'Conflicts with Tosarelli at Paolo Pini. Swap in if you committed to the full Liszt arc instead of the Guinga tribute.',
  },
  {
    id: 'alt-trolese',
    day: 'sat',
    time: '15:40',
    title: 'Axel Trolese — GAM Piano Giardino',
    venue: 'GAM English garden',
    booking: 'Free, walk-in',
    description: 'Award-winning young Italian pianist (Casagrande, debuts at Salzburg, La Scala). Open-air recital in GAM\'s English garden — late afternoon, before the day pivots to Ji Liu and the evening at GAM.',
    whyNot: 'Fits cleanly into the empty afternoon. Swap in to plant yourself at GAM early and ease into the evening — bonus: GAM↔BiM is one metro line.',
  },
  {
    id: 'alt-fluckiger',
    day: 'sat',
    time: '17:00',
    title: 'Esther Flückiger — "Electronic Waves & Female Keys"',
    venue: 'AGON',
    booking: 'Free, walk-in',
    description: 'Swiss-Milanese pianist + electronics. Dedicated program of women composers crossed with electronic processing, at AGON\'s acoustics-research space.',
    whyNot: 'Conflicts with Ji Liu. Swap in if pure electronics + women-composers reading beats the Glass/Bowie transcription idea.',
  },
  {
    id: 'alt-sanderson',
    day: 'sat',
    time: '17:00',
    title: 'Andor Sanderson — "Fragments"',
    venue: 'Stazione di Milano Porta Genova',
    booking: 'Free, walk-in',
    description: 'Original compositions performed inside a working Milan train station — a piano set up under the historic 1870 trainshed canopy.',
    whyNot: 'Conflicts with Ji Liu. Swap in if a piano inside an actual operating train station beats the Glass/Bowie set conceptually.',
  },
  {
    id: 'alt-barrios',
    day: 'sat',
    time: '18:30',
    title: 'Andrés Barrios — "Marea Viva"',
    venue: 'IULM — Giardino del Roseto',
    booking: 'Booking required',
    description: 'Spanish flamenco pianist in IULM\'s rose garden. Solo flamenco-piano at golden hour.',
    whyNot: 'Same slot as Sgobbio. Swap in if you skip Sgobbio and want Mediterranean/flamenco — closer to Fazıl Say\'s Anatolian energy than to Hania Rani.',
  },
  {
    id: 'alt-blaiotta',
    day: 'sat',
    time: '19:50',
    title: 'Danilo Blaiotta — "Around Paolo Conte"',
    venue: 'GAM Piano Giardino',
    booking: 'Free, walk-in',
    description: 'Jazz pianist reworking Paolo Conte\'s repertoire — Italian chanson-jazz crossover, Italian summer evening at GAM\'s garden piano.',
    whyNot: 'Sits in the Sgobbio→Rakotondrabe window. Swap in if you skip Sgobbio and want to camp at GAM for the evening.',
  },
  {
    id: 'alt-ligeti',
    day: 'sat',
    time: '20:00',
    title: 'Ligeti Études intégrale + 30 young composers',
    venue: 'Conservatorio G. Verdi · Sala Colonne',
    booking: 'Free, walk-in',
    description: 'Conservatorio composition students play Ligeti\'s complete Études for piano alongside 30 newly written pieces. The deepest contemporary-piano evening of the festival.',
    whyNot: 'Conflicts with Sgobbio + Rakotondrabe window. Swap in if you want a "serious experimental piano" evening — Ligeti is foundational for the Hania-Rani / Tigran lineage.',
  },
  {
    id: 'alt-boosta',
    day: 'sat',
    time: '21:00',
    title: 'Davide "Boosta" Dileo — "Contro la guerra"',
    venue: 'Casa EMERGENCY',
    booking: 'Free, walk-in',
    description: 'Subsonica\'s keyboardist (one of Italy\'s biggest electronic-rock bands) plays a solo piano set in Gino Strada\'s old house — Emergency\'s headquarters. A peace concert in memory of Strada.',
    whyNot: 'Conflicts with Rakotondrabe. Swap in if the Italian-electronic-rock + political-charge combination matters more than the GAM/Khalifé camp.',
  },
  {
    id: 'alt-faust',
    day: 'sat',
...
const dayConfig = {
  ...
  sat: { number: '02', title: 'Three worlds', label: 'Sat · 16 May', accent: '#72BFD9' },
...
export default function PianoCityProgram() {
  ...
  const [going, setGoing] = useState({
    belli: true, animalia: true, pamart: true,
    nakajima: true, liszt2: true, tosarelli: true,
    segawa: true, jiliu: true, sgobbio: true, rakotondrabe: true, khalife: true, stegonaute: true,
    snorri: true, trabace: true,
      ...
      <div style={{ maxWidth: '780px', margin: '0 auto' }}>
        ...
        <footer style={{
          ...
          <p className="display" style={{ margin: 0, marginBottom: '0.4rem', fontSize: '1.15rem', fontWeight: 500 }}>
            Four days. Eighteen concerts. One sunrise.
          </p>
